    ...
    <section id="certificates" className="bg-indigo-50/50 dark:bg-indigo-500/4">
      ...
      >
        ...
        {/* แถวกะทัดรัด 2 คอลัมน์ (ไอคอนเล็ก + ชื่อบรรทัดเดียว + วันที่) แทนการ์ดใหญ่เดิม
            ...
            grid-cols-1 ตั้งไว้ตั้งแต่ base (มือถือ) จำเป็นมาก: ไม่งั้นตอนยังไม่ถึง sm breakpoint จะไม่มี grid-template-columns
            เลย ทำให้คอลัมน์เดียวนั้นขยายตามความกว้างของชื่อใบเซอร์ที่ยาวที่สุด (ข้อความยาวๆ ไม่ตัดบรรทัดเพราะมี truncate/nowrap)
            แทนที่จะหดตามความกว้างจอ การ์ดเลยล้นขอบจอมือถือ grid-cols-1 (= minmax(0,1fr)) แก้ปัญหานี้โดยตรง */}
